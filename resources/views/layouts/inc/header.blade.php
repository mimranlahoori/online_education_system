            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0" aria-labelledby="page-header-user-dropdown">
                    ...
                    <div class="p-2">
                        ...
                        <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{route('inbox.index')}}">
                            <span>Inbox</span>
                            <i class="fa fa-fw fa-envelope-open opacity-25"></i>
                        </a>
                        <a class="dropdown-item d-flex align-items-center justify-content-between space-x-1" href="{{route('invoices.index')}}">
                            <span>Invoices</span>
